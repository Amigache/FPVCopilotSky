...
class VideoStreamInfoService:
    ...
    def __init__(self, mavlink_bridge: Optional['MAVLinkBridge'] = None, 
    ...
    def start(self) -> bool:
        ...
        self.sender_thread = threading.Thread(
            ...
            daemon=True,
            name="VideoStreamInfoSender"
        )
        self.sender_thread.start()
        print(f"✅ Video Stream Information service started (SysID={self.mavlink_bridge.source_system_id}, CompID=100 CAMERA)")
        return True
    ...
    def _send_video_stream_information(self):
        ...
        try:
            ...
            msg = mav_sender_camera.video_stream_information_encode(
                ...
                bitrate=int(((video_config.width or 960) * (video_config.height or 720) * (video_config.framerate or 30) * 12) / 1000),
                rotation=0,
                hfov=0,
...
def init_video_stream_info_service(mavlink_bridge: Optional['MAVLinkBridge'] = None,
                                   gstreamer_service: Optional['GStreamerService'] = None) -> VideoStreamInfoService:
